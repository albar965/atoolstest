...
int main(int argc, char *argv[])
{
  ...
  QCoreApplication::setApplicationVersion(VERSION_NUMBER_ATOOLSTEST);
...
{
  cmdParser->addOption(QCommandLineOption(shortOpt, QStringLiteral("Run the %1 test class.").arg(shortOpt)));
}
